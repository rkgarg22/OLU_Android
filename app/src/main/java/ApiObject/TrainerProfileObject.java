...
public class TrainerProfileObject {
    ...
    private List<CategoriesListObject> categoriesObjectList;
    ...
    public TrainerProfileObject(String firstName, String lastName, String userImageUrl, String reviews, List<CategoriesListObject> categoriesListObject) {
    ...
    public List<CategoriesListObject> getCategoriesObjectList() {
        return categoriesObjectList;
    }

    public void setCategoriesObjectList(List<CategoriesListObject> categoriesObjectList) {
